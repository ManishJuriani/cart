<html>
	...
	<body>
		<div id="container">
			...
			<div id="main">
				<table id="main_box">
					<form id="reg_form" action="register.do">
						<tr class="fld_box">
							<td class="fld_name">User Name*</td>
							<td class="colon">:</td>
							<td class="fld_input"><input type="text" name="user_name" required placeholder="User Name" /></td>
						</tr>
						...
						<tr class="fld_box" >
							<td></td>
							<td id="sbm_box" align="center"><input id="sbm_btn" type="submit" value="Submit" /></td>
							<td></td>
						</tr>
					</form>
				</table>
